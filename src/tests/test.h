...
Suite *test_s21_create_matrix(void);     // undone
...
Suite *test_s21_transpose(void);         // undone
Suite *test_s21_calc_complements(void);  // undone
Suite *test_s21_determinant(void);       // undone
